...
nbpath = "path/to/your/naivebayes/"
...
results_file_path = os.path.join(nbpath, "NB_ablation_study_results_v1.csv")
best_config_file_path = os.path.join(nbpath, "NB_ablation_best_config_v1.csv")
fig_outfile_path = = os.path.join(nbpath, "NB_ablation_test_hyperpara_heatmap.pdf")
...
ablation_params = {"Naive Bayes": nb_params}
